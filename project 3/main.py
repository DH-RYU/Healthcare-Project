...
if __name__ == '__main__' :
    ...
    parser.add_argument('--load_epoch', type=int, default=119,help='load_peoch for testing')
    parser.add_argument('--train_directory', type=str, default=os.path.join(os.getcwd(),'kits_data','train'))
    parser.add_argument('--test_directory', type=str, default=os.path.join(os.getcwd(),'kits_data','test'))
    
    parser.add_argument('--save_path', type=str, default=os.path.join(os.getcwd(),'saved_model','kits'))
    parser.add_argument('--save_name',type=str,default='kits_unet_1',help='Saving name')
